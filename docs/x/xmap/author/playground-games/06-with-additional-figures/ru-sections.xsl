...
<xsl:stylesheet version="1.0" xmlns:xsl='http://www.w3.org/1999/XSL/Transform'>
    <xsl:variable name="s06_add_figures_ru" select="'Часть 7. Игры с дополнительными фигурами и большими досками'" />
    <xsl:variable name="s06_add_figures__01_maharajah_ru" select="document('01-maharajah/ru.xml')/ru/div" />
    <xsl:variable name="s06_add_figures__02_gothic_chess_ru" select="document('02-gothic-chess/ru.xml')/ru/div" />
